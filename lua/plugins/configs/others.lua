...
M.luasnip = function(opts)
    ...
    ls.add_snippets('typescriptreact', {
        ...
        s('input.class',
            { t('<input className="'), i(1), t('" type="'), i(2, 'text'), t('" name="'), i(3), t('" value="'), i(4), t(
                '"/>') }),
        s('input.id',
            { t('<input id="'), i(1), t('" type="'), i(2, 'text'), t('" name="'), i(3), t('" value="'), i(4), t('"/>') }),
        s('form',
            { t('<form action="'), i(1), t('" method="'), i(2, 'post'), t('">'), t({ '', '  ' }), i(3), t({ '', '</form>' }) }),
        s('form.class',
            { t('<form className="'), i(1), t('" action="'), i(2), t('" method="'), i(3, 'post'), t('">'), t({ '', '  ' }),
                i(4), t({ '', '</form>' }) }),
        s('form.id',
            { t('<form id="'), i(1), t('" action="'), i(2), t('" method="'), i(3, 'post'), t('">'), t({ '', '  ' }), i(4),
                t({ '', '</form>' }) }),
        ...
        s('select.class',
            { t('<select className="'), i(1), t('" name="'), i(2), t('">'), t({ '', '  ' }), i(3), t({ '', '</select>' }) }),
        s('select.id',
            { t('<select id="'), i(1), t('" name="'), i(2), t('">'), t({ '', '  ' }), i(3), t({ '', '</select>' }) }),
